...
async function renderFooter() {
    ...
    const socialHTML = `
        <a href="https://www.instagram.com/norperfumeofficial/" target="_blank" aria-label="Instagram" class="social-link">
        ...
        <a href="https://www.facebook.com/norperfumeofficial/" target="_blank" aria-label="Facebook" class="social-link">
        ...
        <a href="https://www.linkedin.com/company/norperfume/" target="_blank" aria-label="LinkedIn" class="social-link">
    ...
    socialRows.forEach(row => {
        ...
        row.classList.add('social-row-flex');
    });
